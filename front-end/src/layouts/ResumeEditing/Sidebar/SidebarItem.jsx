...
export default function SidebarItem({name, section, elements, handleVisibilityChange}) {
                        ...
                        <li className="my-2 ml-7" key={item}>
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    name={item}
                                    className="h-4"
                                    checked={childCheckboxes[item] && checkbox}
                                    onCheckedChange={(e) => handleChildChange(item, e)}
                                />
